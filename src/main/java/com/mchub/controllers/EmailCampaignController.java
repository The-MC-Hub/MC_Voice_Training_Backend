...
public class EmailCampaignController {
  ...
  public ResponseEntity<ApiResponse<EmailTemplateDTO>> createTemplate(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Template created",
            emailCampaignService.createTemplate(name, subject, htmlContent, designData)));
  }

  @GetMapping("/templates")
  public ResponseEntity<ApiResponse<List<EmailTemplateDTO>>> getAllTemplates() {
    return ResponseEntity.ok(
        ApiResponse.success("Templates fetched", emailCampaignService.getAllTemplates()));
  }
  ...
  public ResponseEntity<ApiResponse<EmailTemplateDTO>> updateTemplate(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Template updated",
            emailCampaignService.updateTemplate(id, name, subject, htmlContent, designData)));
  }
  ...
  public ResponseEntity<ApiResponse<EmailCampaignResponseDTO>> sendCampaign(
      @RequestBody Map<String, Object> body) {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            ...
            emailCampaignService.sendCampaign(
                templateId, subject, targetType, targetPlans, targetRoles, targetEmails)));
  }

  @PostMapping("/campaigns/preview-recipients")
  @SuppressWarnings("unchecked")
  public ResponseEntity<ApiResponse<List<UserPreviewDTO>>> previewRecipients(
      @RequestBody Map<String, Object> body) {
    String targetType = (String) body.getOrDefault("targetType", "ALL");
    List<String> targetPlans = (List<String>) body.get("targetPlans");
    List<String> targetRoles = (List<String>) body.get("targetRoles");
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Preview fetched",
            emailCampaignService.previewRecipients(
                targetType, targetPlans, targetRoles, targetEmails)));
  }

  @PostMapping("/campaigns/count-recipients")
  @SuppressWarnings("unchecked")
  public ResponseEntity<ApiResponse<Integer>> countRecipients(
      @RequestBody Map<String, Object> body) {
    String targetType = (String) body.getOrDefault("targetType", "ALL");
    List<String> targetPlans = (List<String>) body.get("targetPlans");
    List<String> targetRoles = (List<String>) body.get("targetRoles");
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Count fetched",
            emailCampaignService.countRecipients(
                targetType, targetPlans, targetRoles, targetEmails)));
  }
  ...
  public ResponseEntity<ApiResponse<List<EmailCampaignResponseDTO>>> getAllCampaigns() {
    return ResponseEntity.ok(
        ApiResponse.success("Campaigns fetched", emailCampaignService.getAllCampaigns()));
  }

  @GetMapping("/campaigns/{id}")
  public ResponseEntity<ApiResponse<EmailCampaignResponseDTO>> getCampaign(
      @PathVariable String id) {
    return ResponseEntity.ok(
        ApiResponse.success("Campaign fetched", emailCampaignService.getCampaignById(id)));
  }

  @GetMapping("/campaigns/{id}/logs")
  public ResponseEntity<ApiResponse<List<EmailLogDTO>>> getCampaignLogs(@PathVariable String id) {
    return ResponseEntity.ok(
        ApiResponse.success("Logs fetched", emailCampaignService.getCampaignLogs(id)));
  }
  ...
  private EmailTemplate.DesignData parseDesignData(Object raw) {
    ...
    return EmailTemplate.DesignData.builder()
        ...
        .bannerUrl(map.get("bannerUrl"))
        .title(map.get("title"))
        .description(map.get("description"))
        .buttonText(map.get("buttonText"))
        .buttonLink(map.get("buttonLink"))
        .build();
  }
}
