...
public class UserHighlightController {
  ...
  public ResponseEntity<ApiResponse<List<UserHighlight>>> getHighlights(
  ...
  @PostMapping
  public ResponseEntity<ApiResponse<UserHighlight>> createHighlight(
      @RequestBody UserHighlight highlight) {
    String userId = SecurityUtils.getCurrentUserId();
  ...
  public ResponseEntity<ApiResponse<UserHighlight>> updateHighlight(
      @PathVariable String id, @RequestBody UserHighlight request) {
    String userId = SecurityUtils.getCurrentUserId();
