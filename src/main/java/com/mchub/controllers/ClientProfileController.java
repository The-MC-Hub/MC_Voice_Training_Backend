...
public class ClientProfileController {
  ...
  public ResponseEntity<ApiResponse<ClientProfileDTO>> updateProfile(
      @RequestBody ClientProfileDTO profileData) {
    String userId = SecurityUtils.getCurrentUserId();
    ClientProfileDTO updated =
        clientProfileService.updateProfile(Objects.requireNonNull(userId), profileData);
  ...
  public ResponseEntity<ApiResponse<ClientProfileDTO>> createProfile(
      @RequestBody ClientProfileDTO profileData) {
    String userId = SecurityUtils.getCurrentUserId();
    ClientProfileDTO created =
        clientProfileService.createProfile(Objects.requireNonNull(userId), profileData);
