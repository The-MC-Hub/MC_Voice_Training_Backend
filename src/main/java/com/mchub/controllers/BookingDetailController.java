...
public class BookingDetailController {
  ...
  @GetMapping
  public ResponseEntity<ApiResponse<BookingDetailResponseDTO>> getDetail(
  ...
  public ResponseEntity<ApiResponse<BookingDetailResponseDTO>> createOrUpdate(
      @PathVariable String bookingId, @RequestBody CreateBookingDetailRequest req) {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Detail updated successfully", bookingDetailMapper.toResponseDTO(saved)));
  }
}
