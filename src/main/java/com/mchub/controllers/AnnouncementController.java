...
public class AnnouncementController {
  ...
  public ResponseEntity<ApiResponse<Announcement>> triggerDiscount(
      @RequestBody Map<String, String> body) {
  ...
  public ResponseEntity<ApiResponse<Announcement>> triggerFeatureUpdate(
      @RequestBody Map<String, String> body) {
  ...
  public ResponseEntity<ApiResponse<Announcement>> triggerCompetition(
      @RequestBody Map<String, String> body) {
    ...
    String content =
        "Xin chào {{name}},\n\n"
            ...
            + "\"!\n\n"
            + body.getOrDefault(
                "description", "Tham gia ngay để thể hiện tài năng và giành phần thưởng hấp dẫn.")
            + "\n\nTrân trọng,\nĐội ngũ MC Hub";
    Announcement ann =
        announcementService.createFromTrigger(
