...
public class CommunityController {
  ...
  public ResponseEntity<ApiResponse<Page<LeaderboardEntryDTO>>> getLeaderboard(
    ...
    Page<LeaderboardEntryDTO> result =
        communityService.getLeaderboard(type, period, PageRequest.of(page, cappedSize));
    return ResponseEntity.ok(ApiResponse.success(result));
  }

  /**
   * GET /api/v1/community/leaderboard/me Returns the current user's rank entry for a given
   * type+period.
   */
