...
public class BookingPaymentController {
  ...
  private static final org.slf4j.Logger log =
      org.slf4j.LoggerFactory.getLogger(BookingPaymentController.class);
  ...
  public ResponseEntity<ApiResponse<Map<String, Object>>> createBookingPayment(
    ...
    if (booking.getStatus() != BookingStatus.ACCEPTED) {
      throw new AppException(
          ErrorCode.INVALID_BOOKING_STATUS_TRANSITION, "Booking must be ACCEPTED before payment");
    }
  ...
  @PostMapping("/webhook")
  public ResponseEntity<Map<String, String>> handleBookingWebhook(
