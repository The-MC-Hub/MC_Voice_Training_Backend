...
public class AdminController {
  ...
  public ResponseEntity<ApiResponse<UserResponseDTO>> updateUserStatus(
      @PathVariable String id, @RequestBody Map<String, Boolean> body, HttpServletRequest request) {
    ...
    UserResponseDTO dto =
        adminService.updateUserStatus(Objects.requireNonNull(id), isActive, isVerified);
    auditLogService.log(
  ...
  public ResponseEntity<ApiResponse<UserResponseDTO>> updateUserPlan(
      @PathVariable String id, @RequestBody Map<String, String> body, HttpServletRequest request) {
  ...
  public ResponseEntity<ApiResponse<UserResponseDTO>> createUser(
    ...
    UserResponseDTO dto =
        adminService.createUser(
            name, email, password, role, phoneNumber, adminNote, planStr, couponId);
    auditLogService.log(
        SecurityUtils.getCurrentUserId(),
        AuditAction.ADMIN_CREATE_USER,
        "User",
        dto.getId(),
  ...
  public ResponseEntity<ApiResponse<Void>> sendResetEmail(
    ...
    auditLogService.log(
        SecurityUtils.getCurrentUserId(),
        AuditAction.ADMIN_SEND_RESET_EMAIL,
        "User",
        id,
        null,
        request);
  ...
  public ResponseEntity<ApiResponse<Void>> changePassword(
    ...
    auditLogService.log(
        SecurityUtils.getCurrentUserId(),
        AuditAction.ADMIN_CHANGE_PASSWORD,
        "User",
        id,
        null,
        request);
  ...
  public ResponseEntity<ApiResponse<Void>> deleteUser(
    ...
    auditLogService.log(
        SecurityUtils.getCurrentUserId(), AuditAction.ADMIN_DELETE_USER, "User", id, null, request);
  ...
  public ResponseEntity<ApiResponse<Void>> sendNotificationEmail(
    ...
    auditLogService.log(
        SecurityUtils.getCurrentUserId(),
        AuditAction.ADMIN_NOTIFY_EMAIL,
        "User",
        id,
        "{\"subject\":\"" + subject + "\"}",
        request);
  ...
  public ResponseEntity<ApiResponse<String>> migrateDb(HttpServletRequest request) {
    ...
    auditLogService.log(
        SecurityUtils.getCurrentUserId(),
        AuditAction.ADMIN_MIGRATE_DB,
        "System",
        null,
        null,
        request);
    return ResponseEntity.ok(
        ApiResponse.success("Database migration started/completed successfully"));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> setGuestCooldown(@RequestParam int hours) {
    ...
    SystemSetting s =
        systemSettingRepo.findById("GUEST_COOLDOWN_HOURS").orElse(new SystemSetting());
