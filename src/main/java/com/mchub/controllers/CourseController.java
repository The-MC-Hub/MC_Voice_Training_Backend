...
public class CourseController {
  ...
  public ResponseEntity<ApiResponse<List<CourseResponseDTO>>> getRoadmap() {
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Roadmap retrieved", courseService.getMilestoneCourses(userId)));
  }
  ...
  public ResponseEntity<ApiResponse<List<String>>> getCourseTypes() {
    return ResponseEntity.ok(
        ApiResponse.success("Course types retrieved", courseService.getAllCourseTypes()));
  }
  ...
  public ResponseEntity<ApiResponse<CourseResponseDTO>> getCourse(@PathVariable String id) {
    String userId = tryGetUserId();
    return ResponseEntity.ok(
        ApiResponse.success("Course detail retrieved", courseService.getCourseDetail(id, userId)));
  }

  /** GET /api/v1/courses/reading-guides/{id} — get a specific reading guide */
  @GetMapping("/reading-guides/{id}")
  public ResponseEntity<ApiResponse<com.mchub.models.ReadingGuide>> getReadingGuide(
      @PathVariable String id) {
    return ResponseEntity.ok(
        ApiResponse.success("Reading guide retrieved", courseService.getReadingGuide(id)));
  }
  ...
  public ResponseEntity<ApiResponse<CourseResponseDTO.EnrollmentProgressDTO>> enroll(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Enrolled successfully", courseService.enroll(id, userId)));
  }
  ...
  public ResponseEntity<ApiResponse<CourseResponseDTO.EnrollmentProgressDTO>> giftEnroll(
    ...
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success("Gift course enrolled", courseService.giftEnroll(id, userId)));
  }
  ...
  public ResponseEntity<ApiResponse<CourseResponseDTO.EnrollmentProgressDTO>> completeLesson(
      @PathVariable String id, @PathVariable String lessonId) {
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success(
            "Lesson marked complete", courseService.completeLesson(id, lessonId, userId)));
  }
  ...
  public ResponseEntity<ApiResponse<CourseResponseDTO.EnrollmentProgressDTO>> completeReading(
      @PathVariable String id, @PathVariable String readingId) {
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success(
            "Reading marked complete", courseService.completeReading(id, readingId, userId)));
  }
  ...
  public ResponseEntity<ApiResponse<ExerciseResultDTO>> completeExercise(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Exercise submitted", courseService.completeExercise(id, exerciseId, userId, request)));
  }
  ...
  public ResponseEntity<ApiResponse<QuizResultDTO>> submitQuiz(
      @PathVariable String id, @Valid @RequestBody QuizSubmitRequest request) {
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success("Quiz submitted", courseService.submitQuiz(id, userId, request)));
  }
  ...
  public ResponseEntity<ApiResponse<List<CourseResponseDTO>>> myEnrolled() {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Enrolled courses retrieved", courseService.getMyEnrolledCourses(userId)));
  }

  /** GET /api/v1/courses/{id}/progress-stats */
  @GetMapping("/{id}/progress-stats")
  @PreAuthorize("hasAuthority('MC')")
  public ResponseEntity<ApiResponse<CourseProgressStatsDTO>> progressStats(
      @PathVariable String id) {
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success(
            "Progress stats retrieved", courseService.getCourseProgressStats(id, userId)));
  }
  ...
  public ResponseEntity<ApiResponse<List<CertificateResponseDTO>>> myCertificates() {
    String userId = SecurityUtils.getCurrentUserId();
    return ResponseEntity.ok(
        ApiResponse.success("Certificates retrieved", courseService.getMyCertificates(userId)));
  }
