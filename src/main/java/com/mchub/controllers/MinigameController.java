...
public class MinigameController {
  ...
  public ResponseEntity<ApiResponse<List<MinigamePromptDTO>>> getSpeedReaderPrompts(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Prompts retrieved", minigameService.getSpeedReaderPrompts(difficulty, rounds)));
  }
  ...
  public ResponseEntity<ApiResponse<MinigameResultDTO>> submitSpeedReaderRun(
    ...
    return ResponseEntity.ok(
        ApiResponse.success("Run recorded", minigameService.submitSpeedReaderRun(userId, request)));
  }
  ...
  public ResponseEntity<ApiResponse<List<MinigameLeaderboardEntryDTO>>> getLeaderboard(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(
            "Leaderboard retrieved", minigameService.getLeaderboard(gameType, limit)));
  }
}
