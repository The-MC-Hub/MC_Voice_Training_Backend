...
/**
 * Manual MC certificate system is deprecated. Certificates are now auto-issued on course quiz
 * completion via CourseService. These stubs keep the old CertificateController compiling during
 * migration.
 */
@Service
