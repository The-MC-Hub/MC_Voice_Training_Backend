...
public class BookingDetailServiceImpl implements BookingDetailService {
  ...
  public BookingDetail getOrCreate(String bookingId) {
    return bookingDetailRepository
        ...
        .orElseGet(
            () -> {
              BookingDetail detail = BookingDetail.builder().bookingId(bookingId).build();
  ...
  public BookingDetail update(String bookingId, BookingDetail updated) {
    ...
    if (updated.getSpecialGuestNames() != null)
      detail.setSpecialGuestNames(updated.getSpecialGuestNames());
    ...
    if (updated.getDressCodeDetail() != null)
      detail.setDressCodeDetail(updated.getDressCodeDetail());
