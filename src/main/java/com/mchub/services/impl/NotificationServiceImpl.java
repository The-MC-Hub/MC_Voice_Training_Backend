          ...
          .ifPresent(
              user -> {
                ...
                try {
                  ...
                  log.warn(
                      "⚠️ [Notification] Email failed for user {}: {}", userId, e.getMessage());
                }
              });
    }
  }
    ...
    Notification notification =
        notificationRepository
            ...
            .orElseThrow(
                () ->
                    new AppException(
                        ErrorCode.RESOURCE_NOT_FOUND, "Notification not found: " + notificationId));
    if (!notification.getUserId().equals(userId)) {
      throw new AppException(
          ErrorCode.ACCESS_DENIED, "You do not have permission to access this notification");
    }
