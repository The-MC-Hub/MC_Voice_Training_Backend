...
public class DatabaseMigrationService {
  ...
  public void migrateFromMcHub() {
    ...
    if (configuredSourceDbName == null
        || configuredSourceDbName.isBlank()
        || configuredTargetDbName == null
        || configuredTargetDbName.isBlank()) {
      throw new IllegalStateException(
