...
public class NotificationSchedulerService {
  ...
  public void sendStreakReminders() {
    ...
    List<UserStats> atRisk =
        userStatsRepository.findByCurrentStreakGreaterThanAndLastPracticeTimeBetween(
            0, yesterdayStart, todayStart);
    ...
    for (UserStats stats : atRisk) {
      notificationService.notify(
          ...
          "Bạn đang giữ chuỗi "
              ...
              + " ngày. Luyện tập hôm nay để không bị mất streak.",
          "/m/voice/library",
          false);
    }
