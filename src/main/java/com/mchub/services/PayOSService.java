...
public class PayOSService {
  ...
  public Map<String, Object> createPaymentLink(String userId, SubscriptionPlan plan, long orderCode)
      throws Exception {
    return createPaymentLink(userId, plan, orderCode, PlanConfig.priceFor(plan));
  }

  public Map<String, Object> createPaymentLink(
      String userId, SubscriptionPlan plan, long orderCode, int amount) throws Exception {
  ...
  public Map<String, Object> createBookingPaymentLink(String bookingId, long orderCode, int amount)
      throws Exception {
  ...
  public Map<String, Object> createCoursePaymentLink(
      String userId, String courseTitle, long orderCode, int amount) throws Exception {
  ...
  private Map<String, Object> createGenericPaymentLink(
      long orderCode, int amount, String description, String itemName) throws Exception {
    ...
    ResponseEntity<Map> response =
        restTemplate.postForEntity(PAYOS_API + "/v2/payment-requests", request, Map.class);

    Map<String, Object> responseBody = response.getBody();
    if (responseBody == null || !"00".equals(responseBody.get("code"))) {
      String desc =
          responseBody != null ? String.valueOf(responseBody.get("desc")) : "null response";
