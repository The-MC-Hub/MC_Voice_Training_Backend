...
/**
 * Verifies a Google Sign-In ID token (issued client-side by Google Identity Services) and extracts
 * the identity claims we trust.
 */
public interface GoogleTokenVerifierService {
  ...
  record GoogleIdentity(
      String googleId, String email, boolean emailVerified, String name, String pictureUrl) {}
}
