...
public interface VoiceService {
  // Admin methods
  VoiceLessonResponseDTO createLesson(
      String title,
      String content,
  ...
  VoiceLessonResponseDTO updateLesson(
      String id,
      String title,
      String content,
      VoiceLessonCategory category,
  ...
  /**
   * Uploads/replaces the professional MC reference recording for a lesson, used to overlay the
   * user's pitch contour against a reference in the practice UI. Pass null audioFile to clear the
   * existing sample.
   */
  ...
  PracticeSessionResponseDTO analyzePractice(
