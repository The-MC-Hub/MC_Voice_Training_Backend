...
public interface GamificationService {
  ...
  UserStats processPracticeSession(
      String userId,
      String lessonId,
      double accuracy,
      double rhythm,
  ...
  /**
   * Awards XP + a discount voucher for completing a course (quiz passed, first time only — caller
   * is responsible for only invoking this once per user+course).
   *
