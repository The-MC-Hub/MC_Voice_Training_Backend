...
public enum ErrorCode {
  ...
  ACCESS_DENIED(
      HttpStatus.FORBIDDEN, "ERR_1003", "You do not have permission to perform this action"),
  ...
  GOOGLE_ACCOUNT_ALREADY_LINKED(
      HttpStatus.CONFLICT, "ERR_1010", "This Google account is already linked to another user"),
  GOOGLE_EMAIL_MISMATCH(
      HttpStatus.CONFLICT, "ERR_1011", "This Google account's email does not match your account"),
  GOOGLE_UNLINK_BLOCKED_NO_PASSWORD(
      HttpStatus.CONFLICT,
      "ERR_1012",
  ...
  MC_PROFILE_ALREADY_EXISTS(
      HttpStatus.CONFLICT, "ERR_2003", "MC profile already exists for this account"),
  ...
  SERVICE_ACCESS_DENIED(
      HttpStatus.FORBIDDEN, "ERR_3002", "You do not have permission to access this service"),
  MC_NOT_AVAILABLE(HttpStatus.CONFLICT, "ERR_3003", "The MC is busy during this time"),
  SERVICE_ALREADY_DECIDED(
      HttpStatus.CONFLICT, "ERR_3004", "This request has already been processed"),
  ...
  BOOKING_ACCESS_DENIED(
      HttpStatus.FORBIDDEN, "ERR_3012", "You do not have permission to access this booking"),
  BOOKING_ALREADY_DECIDED(
      HttpStatus.CONFLICT, "ERR_3013", "This booking has already been processed"),
  CANNOT_CANCEL_COMPLETED(HttpStatus.BAD_REQUEST, "ERR_3014", "Cannot cancel a completed booking"),
  CANNOT_CANCEL_PAID(
      HttpStatus.BAD_REQUEST, "ERR_3015", "Cannot cancel a paid booking — request refund instead"),
  INVALID_BOOKING_STATUS_TRANSITION(
      HttpStatus.BAD_REQUEST, "ERR_3015", "Invalid booking status transition"),
  BOOKING_DETAIL_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_3016", "Booking details not found"),

  // Payment (4xxx)
  PAYMENT_INIT_FAILED(
      HttpStatus.BAD_GATEWAY, "ERR_4001", "Payment initialization failed, please try again"),
  ...
  LIMIT_EXCEEDED(
      ...
      "ERR_4005",
      "Practice session limit exceeded. Premium upgrade required."),
  TRANSACTION_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_4006", "Transaction not found"),
  WEBHOOK_INVALID_SIGNATURE(
      HttpStatus.UNAUTHORIZED, "ERR_4007", "Webhook signature verification failed"),
  ...
  CERTIFICATE_ACCESS_DENIED(
      ...
      "ERR_5004",
      "You do not have permission to manipulate this certificate"),
  ...
  CONVERSATION_ACCESS_DENIED(
      HttpStatus.FORBIDDEN, "ERR_6002", "You do not have permission to access this conversation"),
  ...
  AVAILABILITY_ACCESS_DENIED(
      HttpStatus.FORBIDDEN,
      "ERR_6010",
      "You do not have permission to delete this availability schedule"),
  ...
  COURSE_ALREADY_ENROLLED(
      HttpStatus.CONFLICT, "ERR_7003", "You are already enrolled in this course"),
  ENROLLMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "ERR_7004", "Enrollment not found"),
  QUIZ_ANSWER_MISMATCH(
      HttpStatus.BAD_REQUEST, "ERR_7005", "Number of answers does not match number of questions"),
  CERTIFICATE_ALREADY_ISSUED(
      HttpStatus.CONFLICT, "ERR_7006", "Certificate already issued for this course"),
  COURSE_REQUIRES_PLAN(
      HttpStatus.PAYMENT_REQUIRED,
      "ERR_7007",
  ...
  // Generic / system (9xxx)
  INTERNAL_ERROR(
      HttpStatus.INTERNAL_SERVER_ERROR, "ERR_9001", "System error, please try again later"),
