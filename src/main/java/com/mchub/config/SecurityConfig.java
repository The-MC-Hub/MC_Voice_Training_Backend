        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/api/v1/auth/**")
                    ...
                    .permitAll()
                    .requestMatchers("/api/v1/scripts/**")
                    .permitAll()
                    .requestMatchers("/api/v1/payment/webhook")
                    .permitAll()
                    .requestMatchers("/api/v1/payment/booking/webhook")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/payment/status/**")
                    .authenticated()
                    .requestMatchers(HttpMethod.GET, "/api/v1/payment/plans")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/payment/flash-deals")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/payment/apply-discount")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/courses")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/courses/{id}")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/courses/reading-guides/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/voice/lessons/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/voice/lessons")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/voice/practice/analyze-guest")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/voice/guest-cooldown-hours")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/community/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/reviews/mc/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/availability/**")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/certificates/mc/**")
                    .permitAll()
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/social-posts")
                    .permitAll()
                    .requestMatchers(HttpMethod.POST, "/api/v1/social-posts/*/click")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/minigames/speed-reader/prompts")
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/v1/minigames/leaderboard")
                    .permitAll()
                    .anyRequest()
                    .authenticated())
        .addFilterBefore(
