...
public class DataSeeder implements CommandLineRunner {
  ...
  private void seedPlanDefinitions() {
    ...
    planDefinitionRepository.saveAll(
        List.of(
            PlanDefinition.builder()
                ...
                .description(
                    "Truy cập miễn phí vào thư viện bài luyện cơ bản. Thích hợp cho người mới bắt đầu khám phá.")
                .priceVnd(0)
                .durationDays(0)
                .aiSessionLimit(3)
                .badge(null)
                ...
                .highlights(
                    List.of(
                        "3 buổi AI coaching/tháng",
                        "Thư viện bài luyện cơ bản",
                        "Lịch sử luyện tập 7 ngày"))
            ...
            PlanDefinition.builder()
                ...
                .description(
                    "Phù hợp cho MC bán chuyên muốn cải thiện đều đặn mỗi tháng với phản hồi AI chuyên sâu.")
                .priceVnd(199000)
                .durationDays(30)
                .aiSessionLimit(20)
                .badge("Phổ biến")
                ...
                .highlights(
                    List.of(
                        "20 buổi AI coaching/tháng",
                        "Toàn bộ thư viện 50+ bài",
                        "Phân tích WER/CER chi tiết",
                        "Lịch sử không giới hạn",
                        "Huy hiệu & bảng xếp hạng"))
                .comparisonEntries(List.of())
                .active(true)
                .build(),
            PlanDefinition.builder()
                ...
                .description(
                    "Không giới hạn luyện tập. Phân tích sâu nhất. Công cụ xây dựng sự nghiệp MC chuyên nghiệp.")
                .priceVnd(399000)
                .durationDays(30)
                .aiSessionLimit(999)
                ...
                .highlights(
                    List.of(
                        "Không giới hạn AI coaching",
                        "Ưu tiên xử lý phân tích giọng",
                        "Script builder & teleprompter",
                        "Báo cáo tiến bộ hàng tuần",
                        "Hỗ trợ 1-1 qua chat",
            ...
            PlanDefinition.builder()
                ...
                .description(
                    "Cam kết dài hạn, giá tốt nhất. Đầy đủ mọi tính năng Professional cộng thêm quyền lợi độc quyền.")
                .priceVnd(2388000)
                .durationDays(365)
                .aiSessionLimit(999)
                ...
                .highlights(
                    List.of(
                        "Tất cả quyền lợi Chuyên Nghiệp",
                        "Thanh toán 1 lần, dùng cả năm",
                        "Ưu tiên truy cập tính năng mới",
                        "Badge độc quyền Annual Member",
                        "Hỗ trợ ưu tiên 24/7"))
                .comparisonEntries(List.of())
                .active(true)
                .build()));
