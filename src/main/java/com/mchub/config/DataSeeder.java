    ...
    public void run(String... args) {
        ...
        standaloneLesson.addAll(List.of(
            VoiceLesson.builder().title("Khai Mạc Gala Dinner Cuối Năm")
                ...
                .description("Luyện tập lời khai mạc Gala Dinner trang trọng, tạo không khí ấm áp và hứng khởi ngay từ đầu chương trình.")
                .content("Kính thưa quý vị đại biểu, quý khách, cùng toàn thể gia đình công ty thân mến!\n\nChào mừng quý vị đến với Gala Dinner thường niên – đêm hội tụ của những thành tích vượt trội và những kết nối đáng nhớ. Năm qua là một hành trình đầy thử thách, nhưng cũng tràn ngập những chiến thắng mà chúng ta đã cùng nhau tạo dựng.\n\nTối nay, chúng ta không chỉ kỷ niệm những con số. Chúng ta tôn vinh tinh thần, sự cống hiến và tình đồng đội đã làm nên điều đó. Xin hãy để lại những bộn bề của năm cũ bên ngoài cánh cửa này, và bước vào một đêm thực sự thuộc về chúng ta.\n\nChương trình tối nay hứa hẹn nhiều bất ngờ, xúc cảm và kỷ niệm không thể nào quên. Một lần nữa, xin kính chào và chúc quý vị một buổi tối thật tuyệt vời!")
                .evaluationHint("Giọng điệu: trang trọng nhưng ấm áp, nhịp độ vừa phải, nhấn mạnh vào các từ khóa cảm xúc.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(25).description("Phát âm chuẩn, rõ từng âm tiết trong các từ trang trọng như 'kính thưa', 'trân trọng'").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu đều đặn, trang trọng, không gấp gáp; nhấn trọng âm đúng từ khóa").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 110–130 wpm; ngắt nghỉ tự nhiên sau các mệnh đề quan trọng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(20).description("Truyền cảm hứng hứng khởi và ấm áp; nhấn mạnh cảm xúc ở những từ khóa chủ chốt").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(10).description("Đọc đúng nội dung, không bỏ sót hay thêm từ").build()
                ))
            ...
            VoiceLesson.builder().title("Dẫn Phần Cocktail Reception")
                ...
                .description("Kỹ năng dẫn dắt phần cocktail reception, tạo không khí giao lưu thoải mái trước Gala chính thức.")
                ...
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm rõ ràng, tự nhiên trong ngữ điệu thân thiện").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu nhẹ nhàng, thoải mái, không gò bó").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(25).description("Tốc độ 120–140 wpm; thể hiện sự tự tin và thư thái").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(25).description("Giọng thân thiện, nhiệt tình nhưng không ồn ào; tạo cảm giác chào đón").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(10).description("Truyền đạt đủ thông tin hướng dẫn đến khách mời").build()
                ))
                .targetWpmMin(120).targetWpmMax(140).passingScore(65)
                .build(),
            VoiceLesson.builder().title("Giới Thiệu Ban Lãnh Đạo Tại Gala")
                .category(VoiceLessonCategory.GALA).difficulty("Medium")
                .description("Kỹ thuật giới thiệu ban lãnh đạo tại sự kiện Gala với sự trang trọng và tôn trọng đúng nghi thức.")
                ...
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(35).description("Phát âm chính xác từng tên người và chức danh; không đọc sai hay ngập ngừng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu trang trọng; trọng âm rõ ở tên và chức vụ quan trọng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 90–110 wpm khi giới thiệu tên; tránh nuốt chữ").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(10).description("Giọng kính trọng, tôn vinh; không thiếu nhiệt tình cũng không thái quá").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(10).description("Đọc đúng toàn bộ tên và chức danh theo kịch bản").build()
                ))
            ...
            VoiceLesson.builder().title("Dẫn Chương Trình Văn Nghệ Gala")
                ...
                .evaluationHint("Giọng điệu hào hứng nhưng không quá kích động. Giới thiệu nghệ sĩ với sự trân trọng.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm tên ban nhạc và tên bài hát rõ ràng, đúng âm").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu hứng khởi ở phần mở đầu; chuyển sang nhẹ nhàng khi mời xem").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ linh hoạt 115–140 wpm; nhanh hơn khi tạo hứng, chậm khi dẫn vào tiết mục").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(30).description("Truyền được cảm giác trân trọng nghệ thuật và sự hào hứng chân thật").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng tên tiết mục và thông tin giới thiệu").build()
                ))
                .targetWpmMin(115).targetWpmMax(140).passingScore(68)
                .build(),
            VoiceLesson.builder().title("Kết Thúc Và Tiễn Khách Gala")
                .category(VoiceLessonCategory.GALA).difficulty("Easy")
                .description("Lời kết thúc chương trình Gala và tiễn khách một cách chu đáo, để lại ấn tượng tốt đẹp.")
                ...
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm rõ, chân thành; không bị nuốt chữ dù giọng mềm mại").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu chậm rãi, nhẹ nhàng phù hợp phần kết thúc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 100–120 wpm; không vội vàng; cảm giác trọn vẹn và chỉn chu").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(35).description("Sự chân thành và biết ơn được thể hiện qua giọng; không máy móc hay chiếu lệ").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung cảm ơn và hướng dẫn tiễn khách").build()
                ))
        ...
        standaloneLesson.addAll(List.of(
            VoiceLesson.builder().title("Bài Khởi Động Giọng Buổi Sáng")
                ...
                .description("Bài luyện khởi động giọng cơ bản giúp làm ấm dây thanh và lấy hơi đúng cách trước khi dẫn chương trình.")
                .content("Chào buổi sáng! Hôm nay chúng ta bắt đầu với bài luyện khởi động giọng.\n\nĐầu tiên, hãy hít thở sâu từ bụng, không phải từ ngực. Đặt tay lên bụng và cảm nhận bụng phình ra khi hít vào, xẹp xuống khi thở ra.\n\nBây giờ, luyện nguyên âm kéo dài: A... E... I... O... U... Mỗi âm kéo dài ít nhất 5 giây, giọng đều và không đứt.\n\nTiếp theo, luyện phụ âm bật: Ba-ba-ba... Pa-pa-pa... Ta-ta-ta... Ka-ka-ka... Rõ ràng, dứt khoát.\n\nCuối cùng, đọc câu luyện giọng cổ điển: 'Phòng không phòng, phòng không phòng không' – tập trung vào sự rõ ràng của từng âm tiết.\n\nLuyện mỗi bài 3 lần, hơi thở đều và ổn định. Giọng tốt bắt đầu từ hơi thở đúng!")
                .evaluationHint("Đánh giá độ rõ ràng của từng âm tiết và sự ổn định của hơi thở.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(40).description("Mỗi âm tiết phải rõ ràng, sắc nét; không nuốt hay pha âm").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp đều đặn, ổn định giữa các cụm luyện tập").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ chậm có kiểm soát; không vội trong bài khởi động").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(5).description("Không yêu cầu cảm xúc – bài kỹ thuật thuần túy").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(15).description("Đọc đúng trình tự các chuỗi luyện âm").build()
                ))
            ...
            VoiceLesson.builder().title("Kỹ Thuật Nhấn Nhá Và Ngắt Nghỉ")
                ...
                .description("Luyện tập kỹ thuật nhấn nhá trọng âm và ngắt nghỉ đúng chỗ để tạo hiệu ứng diễn đạt chuyên nghiệp.")
                .content("Một MC chuyên nghiệp không chỉ đọc đúng chữ, mà còn biết NHẤN đúng chỗ và NGHỈ đúng lúc.\n\nHãy đọc đoạn sau và chú ý dấu gạch chân là nhấn mạnh, dấu | là ngắt ngắn, dấu || là ngắt dài:\n\n'Kính thưa | quý vị đại biểu, || quý khách quý mến! | Hôm nay, | chúng ta cùng nhau | tụ họp nơi đây, || không phải để nhìn lại | những gì đã qua, || mà để cùng nhau | VIẾT TIẾP | những trang sử MỚI.'\n\nĐọc lại lần 2, lần này tự quyết định chỗ nhấn và nghỉ theo cảm nhận của bạn.\n\nGhi nhớ: Nghỉ trước một ý quan trọng tạo sự chú ý. Nghỉ sau một câu quan trọng tạo không gian suy nghĩ. Đừng bao giờ ngắt giữa chừng một ý tưởng chưa hoàn chỉnh.")
                .evaluationHint("Đánh giá việc nhấn trọng âm đúng chỗ và các điểm ngắt nghỉ tự nhiên.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm rõ tại các điểm nhấn mạnh; không bị mờ nhạt ở từ quan trọng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(35).description("Nhấn trọng âm đúng vị trí; ngắt nghỉ đúng thời điểm theo cấu trúc câu").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(25).description("Tốc độ thay đổi có chủ đích; chậm hơn trước điểm nhấn, nhanh hơn sau chuyển tiếp").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(15).description("Trọng âm tạo cảm giác tự nhiên, không máy móc hay cứng nhắc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung đoạn văn mẫu").build()
                ))
                .targetWpmMin(110).targetWpmMax(140).passingScore(68)
                .build(),
            VoiceLesson.builder().title("Kiểm Soát Tốc Độ Nói")
                .category(VoiceLessonCategory.GENERAL).difficulty("Medium")
                .description("Bài luyện kiểm soát tempo nói – biết khi nào nên nói nhanh, khi nào cần chậm lại để tạo hiệu quả.")
                .content("Tốc độ nói là vũ khí bí mật của MC. Quá nhanh – khán giả không kịp theo. Quá chậm – họ mất tập trung.\n\nPhần 1 – NÓI CHẬM (80 wpm): 'Chào... mừng... quý vị... đến với... sự kiện... đặc biệt... tối... nay.' Cảm nhận sức nặng của từng từ.\n\nPhần 2 – TỐC ĐỘ TRUNG BÌNH (130 wpm): 'Chào mừng quý vị đến với sự kiện đặc biệt tối nay. Chúng tôi rất vui được đón tiếp quý vị trong không gian ấm cúng này.'\n\nPhần 3 – NÓI NHANH tạo hứng khởi (160+ wpm): 'Và bây giờ, hãy cùng chào đón tiết mục đặc biệt mà tất cả chúng ta đã mong chờ suốt cả đêm nay!'\n\nBí quyết: Chậm khi công bố tin quan trọng. Vừa khi kể chuyện. Nhanh khi tạo hứng khởi và giới thiệu tiết mục.")
                .evaluationHint("Mục tiêu WPM: 120-140 cho đoạn thông thường. Đánh giá biến đổi tốc độ có chủ đích.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm rõ kể cả khi nói nhanh; không bị méo âm khi tăng tốc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu ổn định trong từng vùng tốc độ; không bị loạn nhịp khi chuyển cấp độ").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(40).description("Phân biệt rõ 3 vùng tốc độ (chậm/trung bình/nhanh); chuyển đổi có chủ đích, không ngẫu nhiên").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(15).description("Cảm xúc phù hợp từng vùng tốc độ: trọng tâm khi chậm, hứng khởi khi nhanh").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng ba đoạn mẫu theo đúng tốc độ yêu cầu").build()
                ))
            ...
            VoiceLesson.builder().title("Xử Lý Tình Huống Mất Điện Thoại Nhắc")
                ...
                .description("Luyện tập ứng xử khi bị mất prompter hoặc giấy tờ – kỹ năng ứng biến linh hoạt của MC chuyên nghiệp.")
                .content("Tình huống: Bạn đang dẫn chương trình, đột nhiên màn hình nhắc lời tắt, hoặc gió thổi bay tờ giấy. Xử lý thế nào?\n\nKỹ thuật 1 – BRIDGE: Dùng câu cầu nối để kéo dài thời gian: 'Và đây là điều mà tôi muốn quý vị thực sự ghi nhớ...' – trong khi đó, bình tĩnh nhớ lại nội dung.\n\nKỹ thuật 2 – RECAP: Tóm tắt lại điều vừa nói: 'Như tôi vừa chia sẻ, chúng ta đang ở giai đoạn quan trọng của chương trình...' Điều này vừa giúp bạn lấy thời gian, vừa củng cố thông điệp cho khán giả.\n\nKỹ thuật 3 – ENGAGE: Hỏi khán giả: 'Quý vị nghĩ điều gì sẽ xảy ra tiếp theo?' Tạo tương tác trong khi bạn bình tĩnh lấy lại nhịp.\n\nLuyện tập: Đọc đoạn kịch bản 30 giây, sau đó đột ngột dừng lại, áp dụng một trong 3 kỹ thuật trên và tiếp tục dẫn tự nhiên.")
                .evaluationHint("Đánh giá sự bình tĩnh, tự nhiên và khả năng chuyển tiếp mượt mà khi xử lý tình huống.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm vẫn rõ ràng dù đang ứng biến; không bị vấp hay lắp").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu tự nhiên khi chuyển sang câu cầu nối; không lộ sự gián đoạn").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ ổn định, không đột ngột tăng vọt hay giảm mạnh khi xử lý sự cố").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(25).description("Giọng bình tĩnh, tự tin; không để khán giả cảm nhận sự hoảng loạn hay mất phương hướng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(20).description("Áp dụng đúng kỹ thuật BRIDGE/RECAP/ENGAGE; chuyển tiếp liền mạch trở lại nội dung chính").build()
                ))
                .targetWpmMin(110).targetWpmMax(145).passingScore(72)
                .build(),
            VoiceLesson.builder().title("Luyện Giọng Với Micro Chuyên Nghiệp")
                .category(VoiceLessonCategory.GENERAL).difficulty("Easy")
                .description("Kỹ thuật sử dụng micro đúng cách – khoảng cách, góc độ và kiểm soát âm lượng khi dùng micro cầm tay.")
                .content("Micro là người bạn đồng hành không thể thiếu của MC. Nhưng không phải ai cũng biết dùng đúng cách.\n\nKhoảng cách lý tưởng: Giữ micro cách miệng khoảng 10-15cm. Quá gần gây méo tiếng. Quá xa giọng sẽ nhỏ và thiếu uy.\n\nGóc độ: Giữ micro thẳng đứng, hơi chếch 15-20 độ về phía sau. Không chĩa thẳng vào miệng.\n\nKiểm tra âm thanh: 'Xin chào, một hai ba, kiểm tra micro. Một hai ba.' – Nói với âm lượng bình thường, không cần hét.\n\nLuyện với đoạn sau và tưởng tượng bạn đang cầm micro thật: 'Kính thưa quý vị, tôi là MC tối nay. Chúng tôi rất vui được phục vụ quý vị trong buổi tối đặc biệt này. Chương trình sẽ bắt đầu sau ít phút nữa, xin quý vị vui lòng ổn định chỗ ngồi.'\n\nGhi nhớ: Micro khuếch đại tất cả – cả giọng tốt lẫn giọng chưa tốt. Luyện tập đúng kỹ thuật từ đầu!")
                .evaluationHint("Đánh giá độ đều của âm lượng và sự rõ ràng ở từng âm tiết.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(30).description("Phát âm rõ từng âm tiết; đặc biệt chú ý phụ âm cuối không bị mất").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu đều đặn, không bị ngắt quãng bất thường").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ vừa phải 120–135 wpm; không quá nhanh hay quá chậm cho đoạn kiểm tra micro").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(15).description("Giọng tự nhiên, tự tin; không bị căng thẳng hay run rẩy").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(15).description("Đọc đúng đoạn hướng dẫn và đoạn luyện tập").build()
                ))
        ...
        standaloneLesson.addAll(List.of(
            VoiceLesson.builder().title("Dẫn Lễ Rước Dâu Ngoài Trời")
                ...
                .description("Kỹ thuật dẫn lễ rước dâu ngoài trời với âm thanh tự nhiên, xử lý tiếng ồn và duy trì cảm xúc.")
                .content("Lễ rước dâu ngoài trời mang một vẻ đẹp riêng, nhưng cũng đặt ra thử thách đặc biệt cho người MC.\n\n'Kính thưa quý vị! Khoảnh khắc mà tất cả chúng ta đã mong chờ đã đến. Từ xa xa, trong làn gió nhẹ của buổi chiều tà, chú rể Minh Tuấn đang bước ra đón người bạn đời của đời mình.'\n\n[Nhấn mạnh: Dừng lại khi đám đông xôn xao, điều chỉnh âm lượng khi có tiếng gió]\n\n'Và kìa! Cô dâu Thanh Hà xinh đẹp trong tà áo trắng tinh khôi, từng bước chân nhẹ nhàng như đang bước ra từ một giấc mơ đẹp. Hai trái tim, một hành trình.'\n\nKỹ năng quan trọng: Luôn hướng mặt về phía khán giả, không quay lưng. Giọng phải đủ lớn nhưng không la hét. Chú ý âm thanh từ môi trường xung quanh để điều chỉnh kịp thời.")
                .evaluationHint("Giọng cảm xúc, đủ âm lượng cho không gian ngoài trời. Nhịp độ chậm rãi, trang trọng.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm rõ kể cả khi phải nói to hơn bình thường để lấn át tiếng ồn ngoài trời").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu chậm rãi, trang trọng; biết dừng khi đám đông ồn để không bị chìm tiếng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 90–115 wpm; chậm hơn trong không gian ngoài trời để giọng truyền xa hơn").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(30).description("Cảm xúc lãng mạn và trang trọng; những từ mô tả cô dâu chú rể phải có sức nặng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung và tên nhân vật trong đoạn kịch bản").build()
                ))
            ...
            VoiceLesson.builder().title("Thông Báo Bất Ngờ Từ Cô Dâu Chú Rể")
                ...
                .description("Cách dẫn dắt những thông báo bất ngờ hoặc màn trình diễn đặc biệt từ cô dâu chú rể trong đám cưới.")
                .content("Đây là kỹ năng quan trọng – tạo sự bất ngờ và hứng khởi cho khán giả trước một màn trình diễn không nằm trong chương trình ban đầu.\n\n'Thưa quý vị! Chú rể Hùng Anh có một điều rất đặc biệt muốn dành tặng cho cô dâu Phương Linh tối nay. Một điều mà chính Phương Linh cũng chưa biết...'\n\n[Tạo sự hồi hộp bằng cách dừng lại]\n\n'Anh ấy đã dành 3 tháng để học một bài hát – bài hát đầu tiên mà họ cùng nghe trong buổi hẹn hò đầu tiên. Và tối nay, trước mặt tất cả chúng ta...'\n\n[Nhấn mạnh, giọng xúc động]\n\n'...anh ấy sẽ tự mình hát tặng người con gái anh yêu. Hùng Anh ơi, sân khấu là của anh!'\n\nBí quyết: Xây dựng kỳ vọng từng bước, mỗi câu tiết lộ thêm một chút, tạo đỉnh điểm cảm xúc trước khi giới thiệu.")
                .evaluationHint("Đánh giá khả năng xây dựng cảm xúc theo từng bước và thời điểm ngắt để tạo hiệu ứng.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm rõ tên cô dâu chú rể và các từ khóa cảm xúc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(25).description("Nhịp điệu leo thang theo từng câu; mỗi câu tiếp theo tạo thêm kỳ vọng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Chậm dần về cuối để tạo đỉnh điểm; ngắt đúng lúc trước câu kết").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(35).description("Giọng hồi hộp, xúc động và hứng khởi tăng dần; câu kết phải bùng nổ cảm xúc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung và thứ tự các chi tiết tạo bất ngờ").build()
                ))
                .targetWpmMin(105).targetWpmMax(130).passingScore(70)
                .build(),
            VoiceLesson.builder().title("Dẫn Phần Giao Lưu Khán Giả Đám Cưới")
                .category(VoiceLessonCategory.WEDDING).difficulty("Medium")
                .description("Kỹ năng tổ chức và dẫn dắt các mini game hoặc giao lưu khán giả trong tiệc cưới một cách vui tươi và tự nhiên.")
                .content("'Thưa quý vị! Để không khí buổi tiệc thêm phần rộn ràng, chúng tôi có một trò chơi nhỏ dành cho những ai muốn ghi tên mình vào danh sách... nhận quà!'\n\n[Tạo tiếng cười và sự hứng thú]\n\n'Luật chơi rất đơn giản: Tôi sẽ hỏi một câu hỏi về cô dâu chú rể, ai giơ tay nhanh nhất và trả lời đúng sẽ nhận phần quà từ ban tổ chức!'\n\n'Câu hỏi đầu tiên: Cô dâu chú rể gặp nhau ở đâu lần đầu tiên?' [Dừng lại, nhìn khán giả]\n\n'Ồ, nhiều người biết quá! Anh kia, xin mời!' [Chỉ về phía một khán giả giơ tay]\n\nKỹ năng quan trọng: Luôn giữ nhịp độ nhanh, năng lượng cao. Khen ngợi tất cả người tham gia dù đúng hay sai. Không để khoảng trống im lặng kéo dài quá 3 giây.")
                .evaluationHint("Giọng vui tươi, năng lượng cao. Đánh giá sự tự nhiên và khả năng tương tác.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm rõ kể cả khi nói nhanh; không bị nuốt chữ khi hứng khởi").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu sôi động, energetic; không để câu nào bị kéo dài lê thê").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(25).description("Tốc độ nhanh 135–155 wpm để duy trì năng lượng; không để khoảng lặng quá 3 giây").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(35).description("Năng lượng vui tươi, nhiệt tình, tự nhiên; không bị giả tạo hay gượng ép").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng luật chơi và câu hỏi trong mini game").build()
                ))
                .targetWpmMin(135).targetWpmMax(155).passingScore(68)
                .build(),
            VoiceLesson.builder().title("Đọc Lời Chúc Từ Người Thân Vắng Mặt")
                .category(VoiceLessonCategory.WEDDING).difficulty("Hard")
                .description("Kỹ thuật đọc thư hoặc lời chúc từ người thân không thể có mặt – đòi hỏi cảm xúc chân thật và kiểm soát giọng.")
                .content("Đây là khoảnh khắc đặc biệt nhất và cũng cảm xúc nhất trong đám cưới. MC cần truyền tải cảm xúc của người viết một cách chân thật.\n\n'Thưa quý vị, thưa cô dâu chú rể! Có một người không thể có mặt tại đây tối nay, nhưng trái tim của người đó luôn dõi theo từng bước của hai em. Bà ngoại Phương Linh, từ Hà Nội, đã gửi những dòng chữ này để tôi đọc thay bà...'\n\n[Giọng chậm lại, xúc động nhưng kiểm soát]\n\n'Con Linh yêu quý của bà! Nhìn con trong tà áo cô dâu hôm nay, bà tưởng như thấy lại hình ảnh mẹ con ngày xưa. Con đã lớn khôn, trưởng thành và xinh đẹp biết bao. Bà chỉ tiếc không được ở đây để ôm con vào lòng...'\n\nGhi nhớ: Đọc chậm hơn bình thường. Cho phép bản thân bị cảm xúc nhưng không mất kiểm soát. Nếu nghẹn ngào, dừng lại một nhịp, hít thở nhẹ rồi tiếp tục.")
                .evaluationHint("Đánh giá độ chân thật của cảm xúc, kiểm soát giọng khi xúc động và nhịp điệu đọc.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm rõ kể cả khi giọng xúc động; không bị vỡ giọng hay nức nở mất kiểm soát").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp đọc thư chậm, trịnh trọng; có điểm dừng cảm xúc tự nhiên").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 80–100 wpm khi đọc thư; cho phép cảm xúc thấm vào từng câu").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(40).description("Cảm xúc chân thật từ người đọc; truyền tải được nỗi nhớ thương của người vắng mặt").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung lá thư theo kịch bản").build()
                ))
                .targetWpmMin(80).targetWpmMax(100).passingScore(72)
                .build(),
            VoiceLesson.builder().title("Dẫn Chương Trình Đám Cưới Song Ngữ")
                .category(VoiceLessonCategory.WEDDING).difficulty("Hard")
                .description("Kỹ năng dẫn chương trình đám cưới có khách mời quốc tế – chuyển đổi liền mạch giữa tiếng Việt và tiếng Anh.")
                .content("Dẫn song ngữ đòi hỏi sự chuyển đổi mượt mà và giữ nguyên cảm xúc qua hai ngôn ngữ.\n\n'Kính thưa quý vị! Ladies and gentlemen!\n\nChào mừng quý vị đến với hôn lễ của Minh và Sarah. Welcome to the wedding ceremony of Minh and Sarah.\n\nHôm nay là ngày đặc biệt không chỉ với gia đình, mà còn với những người bạn đến từ khắp nơi trên thế giới. Today is a special day not only for the families, but also for friends who have come from all corners of the world.\n\nChúng tôi xin gửi lời cảm ơn chân thành nhất đến tất cả quý vị đã hiện diện. We sincerely thank all of you for being here with us tonight.'\n\nBí quyết: Không dịch từng chữ, mà truyền đạt ý. Giữ cùng mức năng lượng trong cả hai ngôn ngữ. Ngắt giữa hai ngôn ngữ tự nhiên, không vội.")
                .evaluationHint("Đánh giá sự trôi chảy khi chuyển đổi ngôn ngữ và mức độ tự nhiên trong phát âm tiếng Anh.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(35).description("Phát âm tiếng Anh chuẩn; âm /th/, /r/, /v/ không bị pha giọng Việt quá nặng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu tự nhiên trong cả hai ngôn ngữ; không bị cứng hay lạc nhịp khi chuyển").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 100–120 wpm; chậm rãi và rõ ràng khi dẫn song ngữ").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(15).description("Cảm xúc nhất quán qua cả hai ngôn ngữ; không bị giảm nhiệt khi chuyển sang tiếng Anh").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(10).description("Nội dung tiếng Anh truyền đạt đúng ý so với đoạn tiếng Việt").build()
                ))
        ...
        standaloneLesson.addAll(List.of(
            VoiceLesson.builder().title("Mở Đầu Talkshow Với Câu Hỏi Provocative")
                ...
                .description("Kỹ thuật mở đầu chương trình bằng câu hỏi gây tranh cãi để thu hút sự chú ý tối đa ngay từ đầu.")
                .content("'Nếu bạn có thể xóa đi một quyết định trong quá khứ, bạn có làm không?'\n\n[Dừng lại 3 giây, nhìn thẳng vào camera]\n\n'Câu hỏi tưởng chừng đơn giản này đã khiến hàng triệu người mất ngủ. Và tối nay, chúng ta sẽ ngồi xuống với người đã trả lời: Không. Dù bất kể điều gì đã xảy ra.'\n\n'Chào mừng đến với Unfiltered – nơi chúng ta không nói những điều người ta muốn nghe, mà nói những điều người ta cần nghe. Tôi là Minh Khoa, và đây là chương trình của những câu chuyện thật.'\n\nKỹ thuật: Câu hỏi provocative không cần trả lời ngay – nó là cái móc giữ khán giả. Giọng phải dứt khoát, không hỏi mà như khẳng định. Ánh mắt thẳng, không nhìn lơ đãng.")
                .evaluationHint("Đánh giá sức mạnh của câu hỏi mở đầu, độ tự tin và khả năng tạo sự tò mò.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm dứt khoát, mạnh mẽ; câu hỏi mở đầu phải được phát âm như một tuyên bố").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu đột ngột dừng sau câu hỏi provocative; khoảng lặng 3 giây được tính vào nhịp").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Chậm và mạnh ở câu hỏi đầu; tăng tốc khi xây dựng context; vừa phải khi giới thiệu chương trình").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(40).description("Giọng tự tin, bí ẩn và kéo người xem vào; câu hỏi phải tạo được cảm giác muốn biết câu trả lời").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng nội dung câu hỏi và phần giới thiệu chương trình").build()
                ))
                .targetWpmMin(100).targetWpmMax(130).passingScore(72)
                .build(),
            VoiceLesson.builder().title("Xử Lý Khách Mời Lạc Đề")
                .category(VoiceLessonCategory.TALKSHOW).difficulty("Hard")
                .description("Kỹ năng điều hướng khéo léo khi khách mời đang nói sang chủ đề khác mà không làm mất lòng họ.")
                .content("Tình huống: Bạn đang phỏng vấn về chủ đề khởi nghiệp, nhưng khách mời đã nói suốt 4 phút về cuộc hôn nhân của họ.\n\nPhương pháp BRIDGE:\n\n'Và tôi rất xúc động khi nghe câu chuyện gia đình của anh. Tôi tin rằng chính nền tảng đó đã cho anh sức mạnh để...' [kết nối về chủ đề chính] '...bước vào thế giới kinh doanh với tất cả sự dũng cảm. Vậy anh có thể kể cho chúng tôi nghe về quyết định đầu tiên anh đưa ra khi bắt đầu khởi nghiệp?'\n\nPhương pháp INTERRUPT GRACEFULLY:\n\n'Xin lỗi anh cho tôi ngắt một chút – điều anh vừa nói rất thú vị và chúng ta sẽ quay lại sau. Nhưng tôi muốn tận dụng thời gian để hỏi anh về...'\n\nGhi nhớ: Không bao giờ ngắt thô lỗ. Luôn ghi nhận những gì khách mời vừa nói trước khi chuyển hướng.")
                .evaluationHint("Đánh giá sự khéo léo trong việc chuyển hướng và duy trì mối quan hệ tốt với khách mời.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm rõ, lịch sự; giọng không bị căng hay gắt khi ngắt lời").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu liền mạch khi BRIDGE; không có khoảng lặng vụng về khi chuyển hướng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ vừa phải 115–135 wpm; không vội vàng hay kéo dài khi redirect").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(30).description("Giọng chân thành khi ghi nhận câu chuyện khách mời; nhiệt tình khi dẫn về chủ đề chính").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(15).description("Áp dụng đúng kỹ thuật BRIDGE hoặc INTERRUPT GRACEFULLY; chuyển tiếp hợp lý").build()
                ))
                .targetWpmMin(115).targetWpmMax(135).passingScore(72)
                .build(),
            VoiceLesson.builder().title("Đặt Câu Hỏi Follow-Up Sắc Bén")
                .category(VoiceLessonCategory.TALKSHOW).difficulty("Hard")
                .description("Luyện kỹ năng lắng nghe sâu và đặt câu hỏi tiếp nối đúng thời điểm để khai thác câu chuyện hay nhất.")
                .content("MC talkshow giỏi không đọc câu hỏi từ giấy. Họ LẮNG NGHE và hỏi những gì cần hỏi.\n\nVí dụ 1:\nKhách mời: 'Tôi từng thất bại hoàn toàn vào năm 2019.'\nCâu hỏi tệ: 'Vâng, hãy kể tiếp về sự nghiệp của bạn.'\nCâu hỏi tốt: 'Thất bại hoàn toàn – ý anh là thất bại theo nghĩa nào? Tài chính, hay còn điều gì khác?'\n\nVí dụ 2:\nKhách mời: 'Đó là quyết định khó nhất tôi từng đưa ra.'\nCâu hỏi tệ: 'Cảm ơn anh, vậy bước tiếp theo anh làm gì?'\nCâu hỏi tốt: 'Có ai biết về quyết định đó không? Gia đình anh phản ứng thế nào?'\n\nLuyện tập: Đọc câu trả lời của khách mời bên dưới và nghĩ ra 3 câu follow-up khác nhau:\n'Tôi đã rời khỏi công việc ổn định để theo đuổi đam mê nhiếp ảnh vào năm 30 tuổi.'")
                .evaluationHint("Đánh giá sự nhạy bén trong việc nắm bắt điểm thú vị và đặt câu hỏi đúng trọng tâm.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm câu hỏi rõ ràng; từ nghi vấn phải nổi bật, không bị mờ nhạt").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(15).description("Nhịp điệu câu hỏi tự nhiên; không đọc như kịch bản có sẵn").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ vừa phải; câu hỏi follow-up được đặt ra chậm rãi, không vội vàng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(25).description("Giọng thể hiện sự tò mò thật sự; không máy móc hay đọc từ danh sách chuẩn bị sẵn").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(25).description("Câu hỏi follow-up chạm đúng điểm mấu chốt trong câu trả lời của khách mời").build()
                ))
            ...
            VoiceLesson.builder().title("Dẫn Talkshow Live Với Khán Giả Trường Quay")
                ...
                .description("Kỹ thuật tương tác song song với khán giả trong trường quay và khán giả xem qua màn hình.")
                .content("Dẫn live talkshow là cân bằng giữa hai thế giới: khán giả ngồi trước mặt và hàng triệu người xem tại nhà.\n\n'Chào mừng đến với Tonight Live! Trước mặt tôi là 200 khán giả nhiệt tình nhất Hà Nội tối nay!' [Hướng về phía khán giả, tạo tiếng vỗ tay]\n\n'Và chào tất cả mọi người đang xem qua màn hình – dù bạn đang ở đâu, căn phòng này cũng có một ghế dành cho bạn.'\n\n[Sau đó quay về khách mời]\n\n'Thưa anh Thanh, tôi có một câu hỏi đến từ khán giả online – bạn Hương ở TP.HCM hỏi: Điều gì đã khiến anh không bỏ cuộc trong những ngày tối tăm nhất?'\n\nBí quyết: Đừng ưu tiên một nhóm khán giả. Camera = cánh cửa kết nối với hàng triệu người. Khán giả trường quay = năng lượng sống cho chương trình.")
                .evaluationHint("Đánh giá khả năng chuyển đổi tự nhiên giữa các đối tượng khán giả khác nhau.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(20).description("Phát âm rõ khi nói với từng đối tượng; không bị giảm chất lượng khi chuyển hướng").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu liền mạch khi chuyển giữa khán giả trường quay, camera và khách mời").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 120–140 wpm; nhanh hơn khi tạo hứng với khán giả, vừa hơn khi hỏi khách mời").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(30).description("Năng lượng nhất quán với cả hai nhóm khán giả; tạo cảm giác ai cũng được chú ý").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(10).description("Đọc đúng câu hỏi từ khán giả online và nội dung giới thiệu chương trình").build()
                ))
                .targetWpmMin(120).targetWpmMax(140).passingScore(68)
                .build(),
            VoiceLesson.builder().title("Kết Thúc Talkshow Để Lại Dư Âm")
                .category(VoiceLessonCategory.TALKSHOW).difficulty("Medium")
                .description("Nghệ thuật kết thúc chương trình với lời kết đáng nhớ, khuyến khích hành động và giữ khán giả quay lại lần sau.")
                .content("Kết thúc talkshow không phải là dừng lại – đó là cú đánh cuối cùng in sâu vào tâm trí khán giả.\n\n'Chúng ta đã cùng nhau trải qua gần một giờ với những câu chuyện truyền cảm hứng, những góc nhìn thay đổi cách chúng ta nghĩ và sống.'\n\n'Câu hỏi tôi muốn để lại cho quý vị tối nay là: Từ ngày mai, bạn sẽ thay đổi một điều nhỏ gì trong cuộc sống của mình?'\n\n[Dừng lại, nhìn thẳng vào camera]\n\n'Đôi khi, một điều nhỏ đó lại là khởi đầu của tất cả.\n\nCảm ơn khách mời đặc biệt của chúng ta – anh Thanh Tùng. Cảm ơn quý vị đã ở lại đến tận cuối. Và hẹn gặp lại vào tuần tới, cùng giờ này, tại đây. Tôi là Minh Khoa – chúc quý vị một đêm ngủ ngon và một ngày mai tươi sáng.'\n\nBí quyết: Câu hỏi để lại = lý do khán giả suy nghĩ về bạn sau khi tắt TV. Lời cảm ơn = chân thành, không vội vàng.")
                .evaluationHint("Đánh giá sức mạnh của lời kết và khả năng tạo ấn tượng lâu dài.")
                .evaluationCriteria(List.of(
                    VoiceLesson.EvaluationCriteria.builder().aspect("PRONUNCIATION").weight(15).description("Phát âm chậm rãi, rõ ràng; câu hỏi để lại phải được phát âm như đinh đóng cột").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("RHYTHM").weight(20).description("Nhịp điệu giảm dần về cuối; khoảng lặng sau câu hỏi để lại là bắt buộc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("PACING").weight(20).description("Tốc độ 105–125 wpm; chậm lại rõ rệt ở câu hỏi để lại và lời cảm ơn").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("EMOTION").weight(40).description("Giọng ấm áp, sâu lắng và chân thành; tạo được dư âm cảm xúc sau khi kết thúc").build(),
                    VoiceLesson.EvaluationCriteria.builder().aspect("ACCURACY").weight(5).description("Đọc đúng lời kết, câu hỏi để lại và phần cảm ơn").build()
                ))
        ...
        if (existingUsers.isEmpty()) {
            ...
            String[][] mockUsersData = {
                {"mai@mchub.vn", "Nguyễn Mai Anh", "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150"},
                {"nam@mchub.vn", "Trần Hoàng Nam", "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150"},
                {"thao@mchub.vn", "Lê Thu Thảo", "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150"},
                {"huy@mchub.vn", "Phạm Minh Huy", "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150"},
                {"tri@mchub.vn", "Vũ Minh Trí", "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150"}
            };
            ...
            log.info("✅ Found {} existing users in database. Using them for gamification seeding.", existingUsers.size());
        ...
        for (int i = 0; i < usersToUse.size(); i++) {
            ...
            if (i == 0) {
                currentStreak = 22; longestStreak = 35; totalHours = 55.4;
                sessions = 120; cumulativeXP = 26500.0; weeklyXP = 3200.0; currentTier = "ELITE_LEGEND";
            } else if (i == 1) {
                currentStreak = 15; longestStreak = 24; totalHours = 42.5;
                sessions = 98; cumulativeXP = 12500.0; weeklyXP = 2100.0; currentTier = "DIAMOND";
            } else if (i == 2) {
                currentStreak = 8; longestStreak = 18; totalHours = 28.0;
                sessions = 64; cumulativeXP = 7600.0; weeklyXP = 1500.0; currentTier = "PLATINUM";
            } else if (i == 3) {
                currentStreak = 4; longestStreak = 10; totalHours = 14.5;
                sessions = 35; cumulativeXP = 3800.0; weeklyXP = 850.0; currentTier = "GOLD";
            } else if (i == 4) {
                currentStreak = 2; longestStreak = 6; totalHours = 8.2;
                sessions = 18; cumulativeXP = 1400.0; weeklyXP = 300.0; currentTier = "SILVER";
            } else {
                currentStreak = (i * 3) % 7; longestStreak = currentStreak + (i % 5) + 1;
                totalHours = 2.5 + (i * 0.7); sessions = 6 + (i * 2);
                cumulativeXP = 350.0 + (i * 150.0); weeklyXP = 100.0 + (i * 30.0);
                if (cumulativeXP >= 20000) currentTier = "ELITE_LEGEND";
                else if (cumulativeXP >= 10000) currentTier = "DIAMOND";
                else if (cumulativeXP >= 5000) currentTier = "PLATINUM";
                else if (cumulativeXP >= 2000) currentTier = "GOLD";
                else if (cumulativeXP >= 800) currentTier = "SILVER";
        ...
        Competition weeklyArena = competitionRepository.save(Competition.builder()
            ...
            .description("Luyện tập kỹ thuật nhấn nhá, nhịp điệu và truyền cảm giọng đọc cho bản tin thời sự 19h của VTV. Top 3 sẽ nhận danh hiệu Champion Badge.")
        ...
        Competition dailyArena = competitionRepository.save(Competition.builder()
            ...
            .description("Dành riêng cho kịch bản dẫn chương trình Gala Dinner doanh nghiệp cuối năm. Tông giọng yêu cầu vui tươi, tràn đầy năng lượng.")
        ...
        if (!usersToUse.isEmpty()) {
            ...
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(weeklyArena.getId()).userId(u0.getId()).userName(u0.getName()).userAvatar(u0.getAvatar())
        ...
        if (usersToUse.size() > 1) {
            ...
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(weeklyArena.getId()).userId(u1.getId()).userName(u1.getName()).userAvatar(u1.getAvatar())
            ...
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(dailyArena.getId()).userId(u1.getId()).userName(u1.getName()).userAvatar(u1.getAvatar())
        ...
        if (usersToUse.size() > 2) {
            ...
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(weeklyArena.getId()).userId(u2.getId()).userName(u2.getName()).userAvatar(u2.getAvatar())
        ...
        if (!usersToUse.isEmpty()) {
            User u0 = usersToUse.get(0);
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(dailyArena.getId()).userId(u0.getId()).userName(u0.getName()).userAvatar(u0.getAvatar())
        ...
        if (usersToUse.size() > 3) {
            ...
            competitionRecordRepository.save(CompetitionRecord.builder()
                .competitionId(dailyArena.getId()).userId(u3.getId()).userName(u3.getName()).userAvatar(u3.getAvatar())
        ...
        List<VoiceLesson> weddingLessons = lessonRepository.saveAll(Arrays.asList(
            ...
            VoiceLesson.builder()
                ...
                .content("Và bây giờ, một trong những nghi thức thú vị nhất của đêm tiệc – lễ cắt bánh cưới! Chiếc bánh nhiều tầng này không chỉ là một tác phẩm nghệ thuật ẩm thực mà còn là biểu tượng cho những tầng hạnh phúc chồng chất trong cuộc sống vợ chồng. Xin kính mời cô dâu chú rể cùng nắm tay nhau thực hiện nhát cắt đầu tiên. Sau đó, kính mời hai bạn nâng ly champagne – những bong bóng nhỏ bé đang nhảy múa trong ánh đèn như tượng trưng cho niềm vui không tắt.")
                .build(),
            VoiceLesson.builder()
                .title("Xử lý sự cố kỹ thuật trong lễ cưới")
                .category(VoiceLessonCategory.WEDDING)
                .difficulty("Hard")
                .description("Kỹ thuật giữ bình tĩnh và ứng phó linh hoạt khi xảy ra sự cố âm thanh hoặc chậm trễ.")
                .content("Thưa quý vị! Trong lúc chúng ta chờ đợi hệ thống âm thanh được kiểm tra lại, tôi xin phép chia sẻ một điều thú vị về đôi uyên ương của chúng ta. Đôi trẻ đã gặp nhau trong một hoàn cảnh rất đặc biệt – và câu chuyện tình yêu của họ chính là bằng chứng rằng duyên số luôn tìm được nhau dù có bất cứ trở ngại nào. Xin quý vị hãy thư giãn và thưởng thức thêm ít phút – chương trình sẽ tiếp tục ngay sau đây. Cảm ơn sự kiên nhẫn của quý vị!")
                .build(),
            VoiceLesson.builder()
        ...
        courseRepository.save(Course.builder()
                ...
                .description("Khóa học toàn diện cho MC đám cưới Việt Nam. Bao gồm kỹ thuật dẫn lễ vu quy, lễ thành hôn, điều phối phần trao nhẫn, giới thiệu quan khách và xử lý tình huống bất ngờ. Hoàn thành 10 bài luyện giọng, 3 bài đọc và bài kiểm tra để nhận chứng chỉ MC Đám Cưới.")
                .slug("mc-dam-cuoi")
                ...
                .quizQuestions(Arrays.asList(
                    Course.QuizQuestion.builder()
                        .question("Trong lễ vu quy truyền thống Việt Nam, MC nên sử dụng tông giọng như thế nào?")
                        .options(Arrays.asList("Vui nhộn, hài hước để tạo không khí sôi động", "Trang trọng, ấm áp và cảm xúc phù hợp với nghi lễ thiêng liêng", "Nhanh và gọn để tiết kiệm thời gian", "Nghiêm túc và lạnh lùng như hội nghị doanh nghiệp"))
                        .correctIndex(1)
                        .explanation("Lễ vu quy là nghi thức thiêng liêng, cần tông giọng trang trọng nhưng vẫn mang hơi ấm cảm xúc để kết nối với hai gia đình.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi hệ thống âm thanh gặp sự cố trong đám cưới, MC nên làm gì đầu tiên?")
                        .options(Arrays.asList("Dừng chương trình và chờ kỹ thuật viên sửa xong", "Giữ bình tĩnh, dùng câu chuyện về đôi trẻ để lấp thời gian trong lúc chờ sửa", "Xin lỗi liên tục và tỏ ra lo lắng để khán giả thông cảm", "Kết thúc buổi lễ sớm hơn kế hoạch"))
                        .correctIndex(1)
                        .explanation("Giữ bình tĩnh là ưu tiên số một. Kể chuyện về đôi trẻ hoặc pha trò nhẹ nhàng giúp duy trì không khí trong khi sự cố được xử lý.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Nghi thức trao nhẫn trong đám cưới có ý nghĩa biểu tượng gì?")
                        .options(Arrays.asList("Thể hiện giá trị tài chính của gia đình", "Chiếc nhẫn tròn tượng trưng cho tình yêu vĩnh cửu, không có điểm bắt đầu hay kết thúc", "Đây chỉ là thủ tục hành chính trong hôn nhân", "Nhẫn thể hiện quyền sở hữu trong hôn nhân"))
                        .correctIndex(1)
                        .explanation("Chiếc nhẫn cưới hình tròn là biểu tượng của tình yêu trọn vẹn và vĩnh cửu – đây là thông điệp MC cần truyền tải trong khoảnh khắc trao nhẫn.")
                        .category("THEORY")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi giới thiệu đại diện hai họ, MC cần cung cấp thông tin gì?")
                        .options(Arrays.asList("Chỉ cần nêu tên, không cần chức danh hay quan hệ", "Tên, mối quan hệ với gia đình và đôi khi chức danh xã hội nếu phù hợp", "Tuổi tác và thành tích học tập của từng người", "Chỉ giới thiệu những người có chức vụ quan trọng"))
                        .correctIndex(1)
                        .explanation("Giới thiệu đầy đủ tên, mối quan hệ và chức danh (nếu phù hợp) thể hiện sự tôn trọng và giúp khán giả hiểu rõ vai trò của từng người.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trong đám cưới miền Nam Việt Nam, phong cách dẫn chương trình thường như thế nào?")
                        .options(Arrays.asList("Nghiêm túc, ít tương tác như đám cưới miền Bắc", "Vui vẻ, phóng khoáng, khán giả thích tương tác và minigame", "Chỉ đọc kịch bản, không ứng xử linh hoạt", "Dùng nhiều từ Hán Việt và ngôn ngữ cổ điển"))
                        .correctIndex(1)
                        .explanation("Đám cưới miền Nam có không khí thân thiện, cởi mở. Khán giả hào hứng tham gia tương tác, minigame vui nhộn được đón nhận tích cực.")
                        .category("THEORY")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("MC nên làm gì khi có khách mời bắt đầu gây ồn hoặc không chú ý?")
                        .options(Arrays.asList("Nhắc nhở thẳng thắn và gay gắt trước toàn hội trường", "Dùng humour nhẹ nhàng hoặc câu hỏi tương tác để điều hướng sự chú ý", "Bỏ qua hoàn toàn và tiếp tục kịch bản", "Dừng chương trình cho đến khi hội trường yên lặng"))
                        .correctIndex(1)
                        .explanation("Humour nhẹ nhàng và tương tác là cách chuyên nghiệp để điều hướng sự chú ý mà không tạo ra tình huống xấu hổ cho ai.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trước khi dẫn đám cưới, MC nên làm gì ít nhất 2 giờ trước khi bắt đầu?")
                        .options(Arrays.asList("Chỉ cần đọc lại kịch bản một lần", "Kiểm tra lịch trình với ban tổ chức, thử âm thanh và gặp gỡ đại diện hai gia đình", "Ăn uống no đủ để có năng lượng dẫn chương trình", "Đến đúng giờ khai mạc là đủ"))
                        .correctIndex(1)
                        .explanation("Chuẩn bị kỹ càng trước sự kiện giúp MC nắm rõ lịch trình, xử lý vấn đề kỹ thuật và hiểu mong muốn của gia đình.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Phát âm chuẩn từ 'hôn nhân' trong tiếng Việt miền Bắc là gì?")
                        .options(Arrays.asList("Nhấn mạnh âm 'hôn' và đọc nhẹ 'nhân'", "Đọc đều hai âm tiết, 'hôn' thanh bằng, 'nhân' thanh ngang", "Kéo dài âm 'nhân' để tạo cảm xúc", "Đọc nhanh như một từ đơn"))
                        .correctIndex(1)
                        .explanation("Phát âm chuẩn 'hôn nhân' cần đọc đều hai âm tiết với đúng thanh điệu: 'hôn' (thanh bằng) và 'nhân' (thanh ngang).")
                        .category("PRONUNCIATION")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi dẫn nghi thức cắt bánh cưới, MC nên tạo không khí như thế nào?")
                        .options(Arrays.asList("Giải thích chi tiết thành phần và cách làm bánh", "Tạo không khí hào hứng, ý nghĩa – bánh nhiều tầng biểu tượng cho hạnh phúc chồng chất", "Chỉ thông báo ngắn gọn 'Mời cô dâu chú rể cắt bánh'", "Đọc thơ dài để tăng tính trang trọng"))
                        .correctIndex(1)
                        .explanation("Nghi thức cắt bánh là khoảnh khắc vui nhộn – MC nên xây dựng không khí hứng khởi và kết nối ý nghĩa biểu tượng của chiếc bánh với tình yêu đôi trẻ.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Lời kết thúc buổi lễ cưới cần đảm bảo những yếu tố gì?")
                        .options(Arrays.asList("Cảm ơn ngắn gọn và nhanh chóng kết thúc", "Cảm ơn chân thành đến khách mời, chúc phúc đôi trẻ và mời khách ở lại tiệc", "Tổng kết toàn bộ chương trình đã diễn ra", "Chỉ cần thông báo giờ kết thúc"))
                        .correctIndex(1)
                        .explanation("Lời kết cần có 3 thành phần: cảm ơn khách mời, lời chúc phúc ý nghĩa cho đôi trẻ, và lời mời tiếp tục thưởng thức tiệc – tạo cảm giác trọn vẹn.")
                        .category("ETIQUETTE")
                        .build()
                ))
                .build());
        ...
        List<VoiceLesson> corporateLessons = lessonRepository.saveAll(Arrays.asList(
            ...
            VoiceLesson.builder()
                ...
                .content("Thưa quý vị, đây là cơ hội tuyệt vời để chúng ta kết nối và mở rộng mạng lưới quan hệ chuyên nghiệp. Trong 30 phút tiếp theo, tôi mời quý vị tham gia vào các cuộc trò chuyện có chủ đích. Tôi sẽ giới thiệu một vài kỹ thuật đơn giản để mở đầu cuộc trò chuyện hiệu quả: bắt đầu bằng câu hỏi mở về dự án hiện tại, sau đó tìm điểm chung để xây dựng kết nối. Hãy nhớ rằng, mỗi mối quan hệ ở đây đều có tiềm năng trở thành sự hợp tác có giá trị.")
                .build(),
            VoiceLesson.builder()
                ...
                .content("Trong các hội nghị lớn, đôi khi xuất hiện những câu hỏi nhạy cảm hoặc tranh luận vượt ngoài kế hoạch. Với tư cách MC, nhiệm vụ của chúng ta là giữ cuộc thảo luận ở mức xây dựng và chuyên nghiệp. Khi một vị khách đặt câu hỏi có tính chất chỉ trích, tôi xin phép diễn giải câu hỏi theo hướng tích cực hơn để chúng ta có thể thảo luận một cách hiệu quả. Cảm ơn vị khách đã nêu lên một điểm quan trọng – đây chính là điều mà chúng ta cần cùng nhau tìm ra giải pháp.")
                .build(),
            VoiceLesson.builder()
                ...
                .content("Kính thưa quý vị! Chúng ta đã trải qua một ngày làm việc đầy hiệu quả và ý nghĩa. Những thảo luận sâu sắc, những cam kết mạnh mẽ được đưa ra trong hôm nay là nền tảng để chúng ta bước vào giai đoạn mới với niềm tin và quyết tâm cao nhất. Thay mặt Ban tổ chức, tôi xin trân trọng cảm ơn toàn thể quý vị diễn giả, đại biểu và các đối tác đã dành thời gian quý báu tham dự. Đây là sự kiện thành công nhờ sự đóng góp của tất cả mọi người. Xin tuyên bố bế mạc Hội nghị và kính chúc quý vị sức khỏe, thành công!")
                .build()
        ));
        ...
        courseRepository.save(Course.builder()
                ...
                .shortDescription("Kỹ năng dẫn chương trình chuyên nghiệp cho hội nghị, gala dinner và lễ ra mắt sản phẩm.")
                .description("Phát triển kỹ năng MC doanh nghiệp đẳng cấp: dẫn hội nghị cấp cao, gala dinner cuối năm, lễ trao giải thưởng và ra mắt sản phẩm. Tập trung vào phong cách dẫn chương trình trang trọng, xử lý thời gian và tương tác với doanh nhân cấp cao.")
                ...
                .quizQuestions(Arrays.asList(
                    Course.QuizQuestion.builder()
                        ...
                        .options(Arrays.asList("Giới thiệu theo thứ tự bảng chữ cái tên", "Chức vụ cao nhất trước, khách quốc tế được ưu tiên giới thiệu đầu", "Giới thiệu theo thứ tự ngồi trên sân khấu", "Người trẻ tuổi nhất được giới thiệu đầu tiên"))
                        .correctIndex(1)
                        .explanation("Giao thức quốc tế quy định giới thiệu theo thứ bậc chức vụ, với khách quốc tế được ưu tiên để thể hiện sự tôn trọng.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trong phiên Q&A tại hội nghị, MC nên xử lý câu hỏi nhạy cảm như thế nào?")
                        .options(Arrays.asList("Từ chối không cho hỏi và chuyển sang câu hỏi khác", "Diễn giải câu hỏi theo hướng xây dựng để tạo thảo luận tích cực", "Trả lời thẳng câu hỏi mà không qua diễn giả", "Ngắt micro của người hỏi"))
                        .correctIndex(1)
                        .explanation("MC có vai trò điều phối – kỹ năng 'reframe' câu hỏi nhạy cảm thành câu hỏi mang tính xây dựng giúp duy trì tính chuyên nghiệp của hội nghị.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Tốc độ nói lý tưởng khi dẫn song ngữ (bilingual) trong hội nghị quốc tế là?")
                        .options(Arrays.asList("Nói nhanh hơn 20% để tiết kiệm thời gian", "Chậm hơn 20% so với bình thường để người nghe kịp theo dõi", "Giữ nguyên tốc độ bình thường", "Nói nhanh khi tiếng Việt, chậm khi tiếng Anh"))
                        .correctIndex(1)
                        .explanation("Khi dẫn song ngữ, giảm tốc độ nói khoảng 20% giúp người nghe không phải liên tục diễn giải, đặc biệt với khán giả không thành thạo ngôn ngữ.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trang phục phù hợp nhất cho MC dẫn hội nghị doanh nghiệp cấp cao là?")
                        .options(Arrays.asList("Trang phục sặc sỡ, nổi bật để thu hút chú ý", "Business formal – vest đen hoặc xanh navy, trang nhã và lịch sự", "Casual jeans và áo polo để thể hiện sự gần gũi", "Áo dài truyền thống trong mọi hoàn cảnh"))
                        .correctIndex(1)
                        .explanation("Business formal (vest tối màu) là chuẩn mực trong môi trường doanh nghiệp cấp cao – thể hiện sự tôn trọng và chuyên nghiệp.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi dẫn lễ ra mắt sản phẩm, yếu tố nào quan trọng nhất để tạo ấn tượng?")
                        .options(Arrays.asList("Đọc đầy đủ thông số kỹ thuật của sản phẩm", "Xây dựng kỳ vọng và tạo khoảnh khắc reveal đầy cảm xúc", "Giải thích giá cả và chính sách khuyến mãi", "Trình chiếu slide thật nhiều"))
                        .correctIndex(1)
                        .explanation("Lễ ra mắt sản phẩm thành công phụ thuộc vào cách MC xây dựng anticipation (kỳ vọng) và tạo ra khoảnh khắc reveal đáng nhớ, không phải thông tin kỹ thuật.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trong gala dinner, MC nên xử lý tình huống trễ giờ như thế nào?")
                        .options(Arrays.asList("Thông báo thẳng thắn rằng chương trình bị trễ và xin lỗi nhiều lần", "Lấp thời gian bằng câu chuyện thú vị, trivia hoặc nhạc nền mà không làm lộ sự trễ giờ", "Bỏ bớt một số tiết mục trong kịch bản", "Mời khán giả ra ngoài chờ"))
                        .correctIndex(1)
                        .explanation("MC chuyên nghiệp 'mua thời gian' một cách tự nhiên thay vì để khán giả nhận thấy sự chậm trễ, giữ không khí tích cực trong suốt sự kiện.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi điều phối panel discussion, số câu hỏi dự phòng nên chuẩn bị cho mỗi chủ đề là?")
                        .options(Arrays.asList("1-2 câu hỏi là đủ", "5-7 câu hỏi để đảm bảo có phương án dự phòng", "Không cần chuẩn bị trước, đặt câu hỏi ngẫu hứng", "Hơn 10 câu hỏi chi tiết"))
                        .correctIndex(1)
                        .explanation("Chuẩn bị 5-7 câu hỏi dự phòng cho mỗi chủ đề giúp MC linh hoạt ứng phó khi thảo luận diễn ra khác kế hoạch hoặc cần đào sâu hơn.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Điều gì KHÔNG nên làm khi phát âm tên diễn giả nước ngoài?")
                        .options(Arrays.asList("Hỏi trực tiếp diễn giả về cách phát âm tên trước buổi lễ", "Đoán tùy tiện và phát âm theo ý mình mà không xác nhận", "Lắng nghe cách người tổ chức phát âm và học theo", "Yêu cầu ban tổ chức cung cấp phiên âm"))
                        .correctIndex(1)
                        .explanation("Phát âm sai tên diễn giả là thiếu tôn trọng nghiêm trọng. Luôn xác nhận cách phát âm trước sự kiện bằng cách hỏi trực tiếp hoặc tra cứu.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trong hội nghị, tại sao MC không nên đặt câu hỏi Yes/No cho diễn giả?")
                        .options(Arrays.asList("Vì câu hỏi Yes/No quá dễ và ai cũng biết câu trả lời", "Vì câu hỏi Yes/No cắt ngắn thảo luận – câu hỏi mở tạo ra nhiều nội dung giá trị hơn", "Vì diễn giả không thích trả lời Yes/No", "Vì quy định của hội nghị không cho phép"))
                        .correctIndex(1)
                        .explanation("Câu hỏi mở (What, How, Why) tạo không gian cho diễn giả chia sẻ sâu hơn, tạo ra nội dung có giá trị cho khán giả thay vì câu trả lời ngắn.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trước khi trao giải thưởng nhân viên, MC cần xác nhận điều gì với bộ phận HR?")
                        .options(Arrays.asList("Chỉ cần có danh sách tên là đủ", "Danh sách chính xác người nhận giải và cách phát âm đúng tên của họ", "Giá trị hiện kim của giải thưởng để thông báo cho khán giả", "Ảnh chụp của từng người nhận giải"))
                        .correctIndex(1)
                        .explanation("Phát âm sai tên nhân viên trong buổi lễ vinh danh là lỗi không thể chấp nhận. Xác nhận danh sách và cách phát âm ít nhất 1 ngày trước là bắt buộc.")
                        .category("ETIQUETTE")
                        .build()
                ))
                .build());
        ...
        courseRepository.save(Course.builder()
                .title("MC Talkshow")
                .shortDescription("Nghệ thuật dẫn talkshow, phỏng vấn và điều phối thảo luận nhóm trên truyền hình và sân khấu.")
                .description("Khóa học chuyên sâu về kỹ năng dẫn talkshow và phỏng vấn. Học cách đặt câu hỏi sâu sắc, điều phối tranh luận, giữ nhịp chương trình và tạo kết nối cảm xúc với khách mời. Áp dụng cho format truyền hình, podcast và sự kiện sân khấu.")
                .slug("mc-talkshow")
                ...
                .quizQuestions(Arrays.asList(
                    Course.QuizQuestion.builder()
                        ...
                        .options(Arrays.asList("Đảm bảo chương trình luôn vui vẻ và sôi động", "Chú ý khi giọng hoặc mắt khách mời thay đổi – đó là dấu hiệu câu chuyện quan trọng và cần đào sâu", "Theo dõi mức độ năng lượng của khán giả", "Đặt câu hỏi theo thứ tự từ dễ đến khó"))
                        .correctIndex(1)
                        .explanation("'Follow the energy' là kỹ thuật phỏng vấn chuyên nghiệp: khi khách mời thể hiện sự hứng khởi hoặc cảm xúc, đó là tín hiệu có câu chuyện thú vị cần khai thác sâu hơn.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi khách mời talkshow bắt đầu xúc động và im lặng, MC nên làm gì?")
                        .options(Arrays.asList("Ngay lập tức đặt câu hỏi khác để phá vỡ sự im lặng awkward", "Cho phép khoảnh khắc lặng đọng lại, bày tỏ sự đồng cảm và để khách mời quyết định tiếp tục", "Chuyển ngay sang khách mời khác", "Xin lỗi và thay đổi chủ đề"))
                        .correctIndex(1)
                        .explanation("Im lặng sau câu trả lời cảm xúc là thiêng liêng – không nên phá vỡ nó. Cho khán giả và khách mời cùng cảm nhận khoảnh khắc đó trước khi tiếp tục.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Trong 4 tầng câu hỏi phỏng vấn, tầng nào tạo ra insight sâu sắc nhất?")
                        .options(Arrays.asList("Surface: 'Bạn làm gì?'", "Meaning: 'Điều đó có nghĩa gì với bạn?'", "Story: 'Điều đó xảy ra như thế nào?'", "Feeling: 'Bạn cảm thấy gì lúc đó?'"))
                        .correctIndex(1)
                        .explanation("Tầng Meaning (ý nghĩa) là sâu nhất – khai thác được giá trị, triết lý và bài học cốt lõi từ trải nghiệm của khách mời, tạo ra nội dung có giá trị nhất cho khán giả.")
                        .category("THEORY")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi điều phối tranh luận, 'steel-manning' có nghĩa là gì?")
                        .options(Arrays.asList("Dùng giọng mạnh mẽ để kiểm soát tranh luận", "Trình bày quan điểm của mỗi bên ở dạng mạnh và thuyết phục nhất có thể", "Đứng về phía quan điểm có lý hơn", "Ngăn chặn tranh luận trước khi nó bắt đầu"))
                        .correctIndex(1)
                        .explanation("Steel-manning là kỹ thuật công bằng: trình bày quan điểm của mỗi bên ở dạng tốt nhất của nó, đảm bảo cuộc tranh luận dựa trên lập luận thực chất.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Dấu hiệu nào cho thấy tranh luận trong talkshow đang mất kiểm soát?")
                        .options(Arrays.asList("Khách mời nói chậm hơn và suy nghĩ kỹ hơn", "Giọng to hơn, khách mời ngắt lời nhau, ngôn ngữ trở nên cá nhân hóa", "Khán giả im lặng chú ý", "Các bên đồng ý với nhau nhiều hơn"))
                        .correctIndex(1)
                        .explanation("Ba dấu hiệu cảnh báo: giọng to và nhanh, ngắt lời lẫn nhau, và dùng ngôn ngữ tấn công cá nhân – MC cần can thiệp ngay lập tức khi thấy những dấu hiệu này.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Ranh giới đạo đức quan trọng nhất khi khai thác cảm xúc trong talkshow là gì?")
                        .options(Arrays.asList("Luôn cần xin phép khách mời trước khi phát sóng", "Không khai thác đau khổ để tăng rating – trauma không phải entertainment", "Không để khách mời khóc trên sóng", "Chỉ hỏi những câu hỏi tích cực"))
                        .correctIndex(1)
                        .explanation("MC có trách nhiệm với khách mời và khán giả: sự cảm xúc cần xuất phát từ kết nối chân thật, không phải từ việc 'khai thác' để tạo drama hay tăng view.")
                        .category("ETIQUETTE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Kỹ thuật 'redirect' trong điều phối tranh luận được dùng khi nào?")
                        .options(Arrays.asList("Khi chương trình sắp hết giờ", "Khi tranh luận đang leo thang và cần chuyển hướng sang câu hỏi quan trọng hơn", "Khi khách mời không trả lời được câu hỏi", "Khi cần giới thiệu sản phẩm quảng cáo"))
                        .correctIndex(1)
                        .explanation("Redirect là công cụ kiểm soát tinh tế: thay vì dừng tranh luận đột ngột, MC dẫn dắt cuộc trò chuyện sang hướng xây dựng hơn bằng một câu hỏi mới.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Mục đích chính của lời kết thúc talkshow là gì?")
                        .options(Arrays.asList("Tóm tắt toàn bộ nội dung đã thảo luận", "Để lại ấn tượng và câu hỏi khiến khán giả tiếp tục suy nghĩ sau khi tắt TV", "Quảng bá tập tiếp theo của chương trình", "Cảm ơn nhà tài trợ và đối tác"))
                        .correctIndex(1)
                        .explanation("Lời kết hiệu quả không tóm tắt – mà để lại một câu hỏi, một cảm xúc hoặc một thách thức khiến khán giả tiếp tục suy nghĩ về chủ đề sau khi chương trình kết thúc.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Khi mời khán giả studio đặt câu hỏi, điều kiện quan trọng MC nên đặt ra là gì?")
                        .options(Arrays.asList("Câu hỏi phải ngắn gọn, không quá 1 câu", "Câu hỏi phải là điều họ thật sự muốn biết, không phải câu hỏi nghe hay", "Câu hỏi phải liên quan đến chủ đề chính của chương trình", "Chỉ nhận câu hỏi từ khán giả được chọn sẵn"))
                        .correctIndex(1)
                        .explanation("Câu hỏi chân thật từ khán giả luôn tạo ra những khoảnh khắc tốt nhất trong talkshow. MC cần khuyến khích tính xác thực thay vì câu hỏi 'nghe hay nhưng rỗng tuếch'.")
                        .category("TECHNIQUE")
                        .build(),
                    Course.QuizQuestion.builder()
                        .question("Kỹ thuật 'active listening' trong phỏng vấn talkshow nghĩa là gì?")
                        .options(Arrays.asList("Ghi chép đầy đủ những gì khách mời nói", "Lắng nghe bằng toàn thân – ánh mắt, ngôn ngữ cơ thể, không chỉ bằng tai", "Luôn gật đầu liên tục để thể hiện sự chú ý", "Đặt câu hỏi tiếp nối ngay sau mỗi câu trả lời"))
                        .correctIndex(1)
                        .explanation("Active listening là lắng nghe toàn diện: ánh mắt, tư thế, biểu cảm khuôn mặt đều truyền đạt rằng bạn đang thật sự hiện diện và quan tâm đến những gì khách mời nói.")
                        .category("TECHNIQUE")
                        .build()
                ))
                .build());
        ...
        List<String> intermediateLessonIds = allSeededLessons.subList(Math.min(10, lessonCount), Math.min(20, lessonCount))
                .stream().map(VoiceLesson::getId).collect(java.util.stream.Collectors.toList());
        ...
        courseRepository.save(Course.builder()
                .title("Foundation")
                .shortDescription("Master the fundamentals of MC voice: breath control, pronunciation, and basic pacing.")
                .description("Build the core technical skills every professional MC needs. This milestone covers diaphragmatic breathing, crisp consonant articulation, tonal control, and basic audience connection. Complete all 10 practice sessions and pass the assessment to unlock Vocal Mastery.")
        ...
        courseRepository.save(Course.builder()
                ...
                .description("Deepen your craft with advanced vocal techniques. Learn to modulate pitch and pace for dramatic effect, read room energy and adapt your delivery in real time, and harness emotional resonance to keep audiences captivated. Requires Foundation completion.")
        ...
        courseRepository.save(Course.builder()
                ...
                .description("The final milestone separates good MCs from elite performers. Cover live broadcast standards, multi-lingual ceremony protocols, crisis improvisation, and commanding 1000+ person venues. Complete this to earn your Elite MC Certificate.")
