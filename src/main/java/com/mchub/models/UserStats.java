...
public class UserStats {
  ...
  @Builder.Default private int loginStreak = 0;

  @Builder.Default private int longestLoginStreak = 0;

  private LocalDate lastLoginDate;

  // Freeze: skipping 1 day won't break streak. Resets to 1 on the 1st of each month.
  @Builder.Default private int freezesAvailable = 1;
  ...
  @Builder.Default private int highScoreStreak = 0;

  @Builder.Default private int longestHighScoreStreak = 0;

  /**
   * Earned badge slugs, e.g. "SESSIONS_100", "HIGH_SCORE_STREAK_5" — awarded once, never removed
   */
  @Builder.Default private List<String> earnedBadges = new ArrayList<>();
}
