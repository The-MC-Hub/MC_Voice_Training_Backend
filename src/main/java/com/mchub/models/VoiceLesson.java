...
public class VoiceLesson {
  ...
  /**
   * Optional professional MC reference recording for this lesson's script. When present, the
   * practice UI can overlay the user's pitch contour against this reference for direct visual
   * comparison.
   */
  ...
  @Builder.Default private List<EvaluationCriteria> evaluationCriteria = new ArrayList<>();

  /** Target WPM range for this lesson type */
  @Builder.Default private int targetWpmMin = 120;

  @Builder.Default private int targetWpmMax = 150;
  ...
  @Builder.Default private int passingScore = 70;

  /** Total number of times this lesson has been practiced (incremented on each analyze call) */
  @Builder.Default private int practiceCount = 0;
