...
/**
 * Unit tests for AuditLogServiceImpl. Regression guard for purgeLogs()'s "never delete logs younger
 * than 3 days" safety floor — verified safe during UC-09 manual system testing (TC-ADM-*) before
 * this JUnit coverage existed.
 */
  ...
  class PurgeLogs {
    ...
    void enforcesThreeDayFloor() {
      ...
      org.mockito.Mockito.verify(auditLogRepository)
          .deleteByCreatedAtBefore(cutoffCaptor.capture());
